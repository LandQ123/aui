...
<style>
  .demo-input.demo-zh-CN {
    ...
    .input-with-select .af-input-group__prepend {
  ...
  .af-autocomplete-suggestion.my-autocomplete {
    li {
      line-height: normal;
      padding: 7px *;
...
:::demo
```html
<af-input v-model="input" placeholder="请输入内容"></af-input>
...
```html
<div>
  <af-input placeholder="请输入内容" v-model="input3">
    <template slot="prepend">Http://</template>
  </af-input>
</div>
<div style="margin-top: 15px;">
  <af-input placeholder="请输入内容" v-model="input4">
...
| restrict | 文本域是否限制字数 | boolean | - | false |
| total-count | 文本域限制总字数 | string / number | - | - |
