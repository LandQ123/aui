...
<div class="buttons">
  <af-button @click="getCheckedNodes">通过 node 获取</af-button>
  <af-button @click="getCheckedKeys">通过 key 获取</af-button>
  <af-button @click="setCheckedNodes">通过 node 设置</af-button>
  <af-button @click="setCheckedKeys">通过 key 设置</af-button>
  <af-button @click="resetChecked">清空</af-button>
</div>
