...
<template>
  <div class="block">
    ...
    <af-slider v-model="value1"></af-slider>
  </div>
  <div class="block">
    <span class="demonstration">自定义初始值</span>
    <af-slider v-model="value2"></af-slider>
  </div>
  <div class="block">
    <span class="demonstration">隐藏 Tooltip</span>
    <af-slider v-model="value3" :show-tooltip="false"></af-slider>
  </div>
  <div class="block">
    <span class="demonstration">格式化 Tooltip</span>
    <af-slider v-model="value4" :format-tooltip="formatTooltip"></af-slider>
  </div>
  <div class="block">
    <span class="demonstration">禁用</span>
    <af-slider v-model="value5" disabled></af-slider>
  </div>
</template>
...
| input-size | 输入框的尺寸 | string | large / medium / small / mini | mini |
