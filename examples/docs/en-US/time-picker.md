...
| is-range | whether to pick a time range, only works with `<af-time-picker>` | boolean | — | false |
| arrow-control | whether to pick time using arrow buttons, only works with `<af-time-picker>` | boolean | — | false |
