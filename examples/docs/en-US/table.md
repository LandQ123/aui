  ...
  <af-table
    ...
    <af-table-column
      ...
      <template slot-scope="scope">
        <af-button @click="handleClick" type="text" size="small">Detail</af-button>
        <af-button type="text" size="small">Edit</af-button>
      </template>
    </af-table-column>
  </af-table>
</template>
...
<template>
  <af-table
    ...
    <af-table-column label="Delivery Info">
      <af-table-column
        prop="name"
        label="Name"
        width="120">
      </af-table-column>
      <af-table-column label="Address Info">
        <af-table-column
          prop="state"
          label="State"
          width="120">
...
<template>
  ...
  <div style="margin-top: 20px">
    <af-button @click="setCurrent(tableData[1])">Select second row</af-button>
    <af-button @click="setCurrent()">Clear selection</af-button>
  </div>
</template>
...
<template>
  ...
  <div style="margin-top: 20px">
    <af-button @click="toggleSelection([tableData3[1], tableData3[2]])">Toggle selection status of second and third rows</af-button>
    <af-button @click="toggleSelection()">Clear selection</af-button>
  </div>
</template>
  ...
  <af-table
    ...
    <af-table-column
      ...
      <template slot-scope="scope">
        <af-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">Edit</af-button>
        <af-button
          size="mini"
          type="danger"
          @click="handleDelete(scope.$index, scope.row)">Delete</af-button>
      </template>
    </af-table-column>
  </af-table>
</template>
...
:::demo To customize row indices, use `index` attribute on <af-table-column> with `type=index`. If it is assigned to a number, all indices will have an offset of that number. It also accepts a method with each index (starting from `0`) as parameter, and the returned value will be displayed as index.
