...
<af-upload
  ...
  :file-list="fileList">
  <af-button size="small" type="primary">Click to upload</af-button>
  <div slot="tip" class="af-upload__tip">jpg/png files with a size less than 500kb</div>
</af-upload>
<script>
  export default {
    data() {
...
<af-upload
  ...
  <i v-else class="af-icon-plus avatar-uploader-icon"></i>
</af-upload>
...
<af-dialog :visible.sync="dialogVisible">
...
<af-upload
  ...
  :file-list="fileList"
  multiple>
  <i class="af-icon-upload"></i>
  <div class="af-upload__text">Drop file here or <em>click to upload</em></div>
  <div class="af-upload__tip" slot="tip">jpg/png files with a size less than 500kb</div>
</af-upload>
```
:::
...
<af-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <af-button slot="trigger" size="small" type="primary">select file</af-button>
  <af-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">upload to server</af-button>
  <div class="af-upload__tip" slot="tip">jpg/png files with a size less than 500kb</div>
</af-upload>
<script>
  export default {
