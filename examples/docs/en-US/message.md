...
```html
<template>
  <af-button :plain="true" @click="open">Show message</af-button>
...
```html
<template>
  <af-button :plain="true" @click="open2">success</af-button>
  <af-button :plain="true" @click="open3">warning</af-button>
  <af-button :plain="true" @click="open">message</af-button>
  <af-button :plain="true" @click="open4">error</af-button>
</template>
...
```html
<template>
  <af-button :plain="true" @click="open5">message</af-button>
  <af-button :plain="true" @click="open6">success</af-button>
  <af-button :plain="true" @click="open7">warning</af-button>
  <af-button :plain="true" @click="open8">error</af-button>
</template>
...
```html
<template>
  <af-button :plain="true" @click="openCenter">Centered text</af-button>
</template>
...
```html
<template>
  <af-button :plain="true" @click="openHTML">Use HTML String</af-button>
</template>
