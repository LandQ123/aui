...
```html
<af-input placeholder="Please input" v-model="input"></af-input>
...
<div class="demo-input-suffix">
  ...
  <af-input
    placeholder="Pick a date"
    v-model="input22">
    <i slot="suffix" class="af-input__icon el-icon-date"></i>
  </af-input>
  <af-input
    placeholder="Type something"
    v-model="input23">
    <i slot="prefix" class="af-input__icon el-icon-search"></i>
  </af-input>
</div>
...
```html
<div>
  <af-input placeholder="Please input" v-model="input3">
    <template slot="prepend">Http://</template>
  </af-input>
</div>
<div style="margin-top: 15px;">
  <af-input placeholder="Please input" v-model="input4">
    <template slot="append">.com</template>
  </af-input>
</div>
<div style="margin-top: 15px;">
  <af-input placeholder="Please input" v-model="input5" class="input-with-select">
    <af-select v-model="select" slot="prepend" placeholder="Select">
      <af-option label="Restaurant" value="1"></af-option>
      <af-option label="Order No." value="2"></af-option>
      <af-option label="Tel" value="3"></af-option>
    </af-select>
...
<af-autocomplete
  ...
  @select="handleSelect">
  <i
    class="af-icon-edit el-input__icon"
    slot="suffix"
