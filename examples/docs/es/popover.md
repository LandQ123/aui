...
<template>
  <af-popover
    ...
    <af-button slot="reference">Hover to activate</af-button>
  </af-popover>
  ...
  <af-popover
    ...
    trigger="click"
    content="this is content, this is content, this is content">
    <af-button slot="reference">Click to activate</af-button>
  </af-popover>
  ...
  <af-button v-popover:popover>Focus to activate</af-button>
  ...
  <af-popover
    ...
    content="this is content, this is content, this is content"
    v-model="visible">
    <af-button slot="reference" @click="visible = !visible">Manual to activate</af-button>
  </af-popover>
</template>
...
<af-popover
  ...
  <af-table :data="gridData">
    <af-table-column width="150" property="date" label="date"></af-table-column>
    <af-table-column width="100" property="name" label="name"></af-table-column>
    <af-table-column width="300" property="address" label="address"></af-table-column>
  </af-table>
  <af-button slot="reference">Click to activate</af-button>
</af-popover>
...
<af-popover
  ...
  <div style="text-align: right; margin: 0">
    <af-button size="mini" type="text" @click="visible2 = false">cancel</af-button>
    <af-button type="primary" size="mini" @click="visible2 = false">confirm</af-button>
  </div>
  <af-button slot="reference">Delete</af-button>
</af-popover>
