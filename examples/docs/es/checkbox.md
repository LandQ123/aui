...
<template>
  ...
  <af-checkbox v-model="checked">Opción</af-checkbox>
</template>
<script>
  export default {
    data() {
...
```html
<template>
  <af-checkbox v-model="checked1" disabled>Opción</af-checkbox>
  <af-checkbox v-model="checked2" disabled>Opción</af-checkbox>
</template>
<script>
  export default {
    data() {
...
<template>
  <af-checkbox-group v-model="checkList">
    <af-checkbox label="Opción A"></af-checkbox>
    <af-checkbox label="Opción B"></af-checkbox>
    <af-checkbox label="Opción C"></af-checkbox>
    <af-checkbox label="disabled" disabled></af-checkbox>
    <af-checkbox label="Seleccionado y deshabilitado" disabled></af-checkbox>
  </af-checkbox-group>
</template>
...
```html
<template>
  <af-checkbox :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange">Marcar todos</af-checkbox>
...
<template>
  <div>
    <af-checkbox v-model="checked3" label="Opción1" border></af-checkbox>
    <af-checkbox v-model="checked4" label="Opción2" border></af-checkbox>
  </div>
  <div style="margin-top: 20px">
    <af-checkbox v-model="checked5" label="Opción1" border size="medium"></af-checkbox>
    <af-checkbox v-model="checked6" label="Opción2" border size="medium"></af-checkbox>
  </div>
  <div style="margin-top: 20px">
    <af-checkbox-group v-model="checkboxGroup5" size="small">
      <af-checkbox label="Opción1" border></af-checkbox>
      <af-checkbox label="Opción2" border disabled></af-checkbox>
    </af-checkbox-group>
  </div>
  <div style="margin-top: 20px">
    <af-checkbox-group v-model="checkboxGroup6" size="mini" disabled>
      <af-checkbox label="Opción1" border></af-checkbox>
      <af-checkbox label="Opción2" border></af-checkbox>
    </af-checkbox-group>
  </div>
</template>
