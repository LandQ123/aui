...
:::demo Vincule una variable con `v-model` en el elemento <af-input-number> y estará listo.

```html
<template>
  <af-input-number v-model="num1" @change="handleChange" :min="1" :max="10"></af-input-number>
</template>
<script>
  export default {
    data() {
...
```html
<template>
  <af-input-number v-model="num8" controls-position="right" @change="handleChange" :min="1" :max="10"></af-input-number>
</template>
<script>
  export default {
    data() {
