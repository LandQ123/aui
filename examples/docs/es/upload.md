...
<af-upload
  ...
  :file-list="fileList">
  <af-button size="small" type="primary">Clic para subir archivo</af-button>
  <div slot="tip" class="af-upload__tip">Solo archivos jpg/png con un tamaño menor de 500kb</div>
</af-upload>
<script>
  export default {
    data() {
...
<af-upload
  ...
  <div class="af-upload__text">Suelta tu archivo aquí o <em>haz clic para cargar</em></div>
  <div slot="tip" class="af-upload__tip">Solo archivos jpg/png con un tamaño menor de 500kb</div>
</af-upload>
```
:::
...
<af-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <af-button slot="trigger" size="small" type="primary">Selecciona un archivo</af-button>
  <af-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">Cargar al servidor</af-button>
  <div slot="tip" class="af-upload__tip">Solo archivos jpg/png con un tamaño menor de 500kb</div>
</af-upload>
<script>
  export default {
