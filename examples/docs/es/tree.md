...
:::demo
```html
<af-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></af-tree>
...
<div class="buttons">
  <af-button @click="getCheckedNodes">get by node</af-button>
  <af-button @click="getCheckedKeys">get by key</af-button>
  <af-button @click="setCheckedNodes">set by node</af-button>
  <af-button @click="setCheckedKeys">set by key</af-button>
  <af-button @click="resetChecked">reset</af-button>
</div>
