...
<div class="block">
  ...
  <af-color-picker v-model="color1"></af-color-picker>
</div>
<div class="block">
  <span class="demonstration">No especifica valor por defecto</span>
  <af-color-picker v-model="color2"></af-color-picker>
</div>
...
```html
<af-color-picker v-model="color3" show-alpha></af-color-picker>
...
:::demo
```html
<af-color-picker v-model="color4"></af-color-picker>
<af-color-picker v-model="color4" size="medium"></af-color-picker>
<af-color-picker v-model="color4" size="small"></af-color-picker>
<af-color-picker v-model="color4" size="mini"></af-color-picker>
