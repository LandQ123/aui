...
| is-range          | si es posible escoger un rango de tiempo, solo funciona con `<af-time-picker>` | boolean                                  | —                                        | false                |
| arrow-control     | si es posible escoger el tiempo usando los botones de flecha, solo funciona con `<af-time-picker>` | boolean                                  | —                                        | false                |
