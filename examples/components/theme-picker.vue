...
<style>
  ...
  .theme-picker .af-color-picker__trigger {
    vertical-align: middle;
  }
  
  .theme-picker-dropdown .af-color-dropdown__link-btn {
    display: none;
  }
</style>
  ...
  export default {
    ...
    watch: {
      theme(val, oldVal) {
        ...
        if (!this.chalk) {
          const url = `https://unpkg.com/aui@${ version }/lib/theme-chalk/index.css`;
