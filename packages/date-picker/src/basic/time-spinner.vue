<template>
  <div class="af-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <af-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="af-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="af-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="af-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="af-time-spinner__arrow af-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="af-time-spinner__arrow af-icon-arrow-down"></i>
        <ul class="af-time-spinner__list" ref="hours">
          <li
            class="af-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="af-time-spinner__arrow af-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="af-time-spinner__arrow af-icon-arrow-down"></i>
        <ul class="af-time-spinner__list" ref="minutes">
          <li
            class="af-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="af-time-spinner__arrow af-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="af-time-spinner__arrow af-icon-arrow-down"></i>
        <ul class="af-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      ...
      handleScroll(type) {
        const value = Math.min(Math.floor((this.$refs[type].wrap.scrollTop - (this.scrollBarHeight(type) * 0.5 - 10) / this.typeItemHeight(type) + 8) / this.typeItemHeight(type)), (type === 'hours' ? 23 : 59));
        this.modifyDateField(type, value);
      },
