<template>
  <transition name="af-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="af-picker-panel af-date-picker af-popper"
      :class="[{
      ...
      <div class="af-picker-panel__body-wrapper">
        ...
        <div class="af-picker-panel__body">
          <div class="af-date-picker__time-header" v-if="showTime">
            <span class="af-date-picker__editor-wrap">
              <af-input
            ...
            <span class="af-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <af-input
                ref="input"
          ...
          <div
            class="af-date-picker__header"
            :class="{ 'af-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="af-picker-panel__icon-btn af-date-picker__prev-btn af-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="af-picker-panel__icon-btn af-date-picker__prev-btn af-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="af-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="af-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`el.datepicker.nextYear`)"
              class="af-picker-panel__icon-btn af-date-picker__next-btn af-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="af-picker-panel__icon-btn af-date-picker__next-btn af-icon-arrow-right">
            </button>
          </div>

          <div class="af-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
      ...
      <div
        class="af-picker-panel__footer"
        v-show="footerVisible && currentView === 'date'"
        v-if="selectionMode === 'dates'">
        <!-- <af-button
          size="mini"
          type="text"
