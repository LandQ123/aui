<template>
  <transition
    ...
    <div
      v-show="visible"
      class="af-time-range-picker af-picker-panel af-popper"
      :class="popperClass">
      <div class="af-time-range-picker__content">
        <div class="af-time-range-picker__cell">
          <!-- <div class="af-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div> -->
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="af-time-range-picker__body af-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="af-time-range-picker__cell">
          <!-- <div class="af-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div> -->
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="af-time-range-picker__body af-time-panel__content">
            <time-spinner
        ...
        <span class="af-time-range-picker__separator">-</span>
      </div>
      <!-- <div class="af-time-panel__footer">
        <button
          type="button"
          class="af-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled">{{ t('el.datepicker.confirm') }}</button>
        <button
          type="button"
          class="af-time-panel__btn cancel"
