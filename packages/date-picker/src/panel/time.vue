<template>
  <transition name="af-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="af-time-panel af-popper"
      :class="popperClass">
      <div class="af-time-panel__content" :class="{ 'has-seconds': showSeconds, 'is-arrow': useArrow }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
      ...
      <!-- <div class="af-time-panel__footer" :class="{ 'is-arrow': useArrow }">
        <button
          type="button"
          class="af-time-panel__btn"
