import { createVue, triggerClick, destroyVM, triggerKeyDown } from '../../../test/unit/util';
...
describe('Autocomplete', () => {
  ...
  it('create', done => {
    ...
    setTimeout(_ => {
      ...
      expect(suggestions.querySelectorAll('.af-autocomplete-suggestion__list li').length).to.be.equal(4);
  ...
  it('select', done => {
    ...
    setTimeout(_ => {
      ...
      const suggestionList = suggestions.querySelectorAll('.af-autocomplete-suggestion__list li');
  ...
  it('highlight', done => {
    ...
    setTimeout(_ => {
      ...
      vm.$nextTick(_ => {
        const suggestions = autocomplete.$refs.suggestions.$el.querySelector('.af-autocomplete-suggestion__wrap');
        let suggestionsList = suggestions.querySelectorAll('.af-autocomplete-suggestion__list li');
  ...
  it('highlight out of bounds', done => {
    ...
    setTimeout(_ => {
      ...
      vm.$nextTick(_ => {
        const suggestions = autocomplete.$refs.suggestions.$el;
        const suggestionsList = suggestions.querySelectorAll('.af-autocomplete-suggestion__list li');
