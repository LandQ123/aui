...
describe('Button', () => {
  ...
  it('create', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('af-button--primary')).to.be.true;
  });
  it('icon', () => {
    vm = createTest(Button, {
      icon: 'af-icon-search'
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.querySelector('.af-icon-search')).to.be.ok;
  });
  it('nativeType', () => {
    vm = createTest(Button, {
      nativeType: 'submit'
  ...
  it('loading', () => {
    ...
    expect(buttonElm.querySelector('.af-icon-loading')).to.be.ok;
  });
  it('disabled', () => {
    vm = createTest(Button, {
      disabled: true
  ...
  it('size', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('af-button--medium')).to.be.true;
  });
  it('plain', () => {
    vm = createTest(Button, {
      plain: true
  ...
  it('click', done => {
    ...
    vm = createVue({
      template: `
        <af-button @click="handleClick"></af-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
  ...
  it('click inside', done => {
    ...
    vm = createVue({
      template: `
        <af-button @click="handleClick"><span class="inner-slot"></span></af-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
  ...
  it('loading implies disabled', done => {
    ...
    vm = createVue({
      template: `
        <af-button loading @click="handleClick"><span class="inner-slot"></span></af-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
