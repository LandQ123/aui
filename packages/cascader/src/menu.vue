<script>
  import { isDef } from 'aui/src/utils/shared';
  ...
  export default {
    ...
    render(h) {
      ...
      const menus = this._l(activeOptions, (menu, menuIndex) => {
        ...
        const items = this._l(menu, item => {
          ...
          return (
            <li
              class={{
                'af-cascader-menu__item': true,
                'af-cascader-menu__item--extensible': item.children,
        ...
        return (
          <ul
            class={{
              'af-cascader-menu': true,
              'af-cascader-menu--flexible': isFlat
            }}
            {...hoverMenuEvent}
            style={menuStyle}
            refInFor
      ...
      return (
        <transition name="af-zoom-in-top" on-before-enter={this.handleMenuEnter} on-after-leave={this.handleMenuLeave}>
          <div
            v-show={visible}
            class={[
              'af-cascader-menus af-popper',
              popperClass
            ]}
            ref="wrapper"
          >
