...
describe('Slider', () => {
  ...
  it('should not exceed min and max', done => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value" :min="50">
          </af-slider>
        </div>
      `,
  ...
  it('hide tooltip', () => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value" :show-tooltip="false">
          </af-slider>
        </div>
      `,
  ...
  it('format tooltip', () => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value" :format-tooltip="formatTooltip">
          </af-slider>
        </div>
      `,
  ...
  it('drag', done => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value" :vertical="vertical"></af-slider>
        </div>
      `,
  ...
  it('accessibility', done => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value"></af-slider>
        </div>
      `,
    ...
    vm = createVue({
      template: `
        <div style="width: 200px;">
          <af-slider v-model="value" :min="0" :max="1" :step="0.1"></af-slider>
        </div>
      `,
  ...
  it('change event', done => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value" @change="onChange">
          </af-slider>
        </div>
      `,
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value" disabled></af-slider>
        </div>
      `,
  ...
  it('show input', done => {
    vm = createVue({
      template: `
        <div>
          <af-slider v-model="value" show-input></af-slider>
        </div>
      `,
    ...
    setTimeout(() => {
      triggerEvent(vm.$el.querySelector('.af-input-number'), 'keyup');
      const inputNumber = vm.$el.querySelector('.af-input-number').__vue__;
  ...
  it('show stops', () => {
    ...
    const stops = vm.$el.querySelectorAll('.af-slider__stop');
  ...
  it('vertical mode', done => {
    vm = createVue({
      template: `
        <div>
          <af-slider vertical v-model="value" height="200px"></af-slider>
        </div>
      `,
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      vm = createVue({
        template: `
        <div>
          <af-slider v-model="value" range></af-slider>
        </div>
      `,
    ...
    it('should not exceed min and max', done => {
      vm = createVue({
        template: `
        <div>
          <af-slider v-model="value" range :min="50">
          </af-slider>
        </div>
      `,
    ...
    it('click', done => {
      vm = createVue({
        template: `
        <div style="width: 200px;">
          <af-slider range v-model="value"></af-slider>
        </div>
      `,
    ...
    it('responsive to dynamic min and max', done => {
      vm = createVue({
        template: `
        <div>
          <af-slider v-model="value" range :min="min" :max="max">
          </af-slider>
        </div>
      `,
