...
export default {
                  ...
                  this._l(columns, (column, cellIndex) =>
                    <th
                      ...
                      <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                        ...
                        {
                          column.filterable
                            ? <span class="af-table__column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['af-icon-arrow-down', column.filterOpened ? 'af-icon-arrow-up' : ''] }></i></span>
                            : ''
                        }
                      </div>
                    </th>
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.af-table__column-filter-trigger') || cell;
