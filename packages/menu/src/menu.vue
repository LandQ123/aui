<script type="text/jsx">
  ...
  import Menubar from 'aui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'aui/src/utils/dom';
  ...
  export default {
    ...
    render (h) {
      const component = (
        <ul
          ...
          class={{
            'af-menu--horizontal': this.mode === 'horizontal',
            'af-menu--collapse': this.collapse,
            "af-menu": true
          }}
        >
          { this.$slots.default }
        ...
        render(createElement, context) {
          const data = {
            ...
            on: {
              ...
              enter(el) {
                addClass(el, 'af-opacity-transition');
                el.style.opacity = 1;
              },

              afterEnter(el) {
                removeClass(el, 'af-opacity-transition');
                el.style.opacity = '';
              },
              ...
              beforeLeave(el) {
                ...
                if (hasClass(el, 'af-menu--collapse')) {
                  removeClass(el, 'af-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
                  addClass(el, 'af-menu--collapse');
                } else {
                  addClass(el, 'af-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
    ...
    watch: {
      ...
      collapse(value) {
        ...
        this.broadcast('AfSubmenu', 'toggle-collapse', value);
      }
    },
    methods: {
