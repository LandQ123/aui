...
<details>
  ...
  ```html
  <af-button @click="handleButtonClick">Click Me</af-button>
  ```
...
<details>
  ...
  <af-table-column label="操作">
    <template slot-scope="props">
      <af-button @click.native="showDetail(props.row)">查看详情</af-button>
    </template>
  </af-table-column>
  ```
  参数 `row` 即为对应行的数据。
...
<details>
  ...
  ```html
  <af-table-column label="Operations">
    <template slot-scope="props">
      <af-button @click.native="showDetail(props.row)">Details</af-button>
    </template>
  </af-table-column>
  ```
...
<details>
  ...
  ```html
  <af-button @click="handleButtonClick">Haga Clic Aquí</af-button>
  ```
...
<details>
  ...
  ```html
  <af-table-column label="Operaciones">
    <template slot-scope="props">
      <af-button @click.native="verDetalles(props.row)">Detalles</af-button>
    </template>
  </af-table-column>
  ```
